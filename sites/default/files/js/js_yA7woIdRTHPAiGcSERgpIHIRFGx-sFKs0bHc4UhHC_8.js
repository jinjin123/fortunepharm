...
"use strict";jQuery(document).ready(function(){var a=jQuery,n=a(window);a("#btn-open-all-nyu").bind("click",function(){a("#popup-all-nyu").addClass("active")}),a("#btn-close-all-nyu").bind("click",function(){a("#popup-all-nyu").removeClass("active")}),a(".main-menu-toggle, #btn-close-navigation").click(function(){a("#navigation, #global-topbar, #modalBackdrop").toggleClass("active")}),!(0<window.location.href.indexOf("/en"))&&0<window.location.href.indexOf("/zh-hans")?a("ul.links > li.zh-hans").css("display","none"):a("ul.links > li.en").css("display","none"),a("#topbar-search-toggle").bind("click",function(){a("#topbar-search-form .form-text").hasClass("active")&&0<a("#topbar-search-form .form-text").val().length?(a("#topbar-search-form #search-block-form").submit(),a(window).width()<=400?(a(".topbar-search .topbar-search-form").css({right:"-78px"}),a(".topbar-logo").hide()):a(".topbar-search .topbar-search-form").css({right:"12px"})):(a(window).width()<=400?(a(".topbar-search .topbar-search-form").css({right:"-78px"}),a(".topbar-logo").hide()):a(".topbar-search .topbar-search-form").css({right:"12px"}),a("#topbar-search-form .form-text").addClass("active").focus())}),a("#topbar-search-form .form-text").bind("blur",function(){var e=a(this);setTimeout(function(){e.removeClass("active").text(""),a(".topbar-search .topbar-search-form").css({right:"0"}),a(".topbar-logo").show()},100)}),function(){a(".navigation .main-menu >li.root ul").each(function(){a(this).addClass("sub-menu"),a(this).find("ul").addClass("nested sub-menu")}),a(".navigation .main-menu >li").each(function(){a(this).find(">.is-active")&&(a(this).find(">.is-active").parent().addClass("opened"),a(this).find(">.is-active").parent().find("> ul").show())}),a(".navigation .main-menu >li .sub-menu > li").each(function(){a(this).find(">.is-active")&&(a(this).find(">.is-active").parent(".root").addClass("opened"),a(this).find(">.is-active").parent(".root").find("> .nested").show(),a(this).find(">.is-active").parent().parent().show(),a(this).find(">.is-active").parent().parent().parent().addClass("opened"),a(this).find(">.is-active").parent().parent().addClass("opened"))}),a(".navigation .main-menu >li .nested > li").each(function(){a(this).find(">.is-active")&&(a(this).find(">.is-active").parents().show(),a(this).find(">.is-active").parents().addClass("opened"))});var s=a(".header .main-nav-menu"),i=a(".main-menu-toggle");a(".navigation .main-menu li").on("click",function(e){a(this).hasClass("opened")?(a(this).removeClass("opened"),a(this).addClass("closed")):a(this).addClass("opened"),a(this).children("ul").toggle(),a(this).children("ul").toggleClass("opened"),e.stopPropagation()}),a("#block-nyu-theme-mainnavigation .main-menu li").on("click",function(e){a(this).hasClass("opened")?(a(this).removeClass("opened minus"),a(this).addClass("closed")):(a(this).removeClass("closed"),a(this).addClass("opened minus")),a(this).children("ul").toggle(),a(this).children("ul").toggleClass("opened"),e.stopPropagation()}),i.on("click",function(){var e=a(this);e.hasClass("opened")?(i.removeClass("opened").addClass("closed"),s.fadeOut(300)):(e.removeClass("closed").addClass("opened"),s.fadeIn(300))}),n.on("resize",function(){800<=n.width()&&i.hasClass("closed")&&s.css("display","flex"),n.width()<800&&"flex"===s.css("display")&&i.addClass("closed")&&s.css("display","none")})}();var s,i,o=a(".header #search"),t=a(".header .top-nav-search-icon"),c=a(".header #block-searchform #edit-keys"),l=a(".header #block-searchform #edit-submit"),d=document.querySelector(".header #block-searchform #edit-keys");!function(){t.on("click",function(){if(n.width()<=600)window.location.href="/search/node";else{var e=a(this);e.hasClass("opened")?(c.val()&&0!==c.val().length&&l.trigger("click"),o.fadeOut("fast"),e.removeClass("opened").addClass("closed")):(o.fadeIn("fast"),e.removeClass("closed").addClass("opened"))}});o.on("input",function(e){try{d&&(d.value=o.val())}catch(e){console.log(e),window.location.href="/search/node?keys="+o.val()}}).on("focus",function(e){0}).on("blur",function(e){0}).keyup(function(e){13===e.which&&c.val()&&0!==c.val().length&&l.trigger("click")}),a(document.body).on("click",function(e){var s=a(e.target);s.is(".top-nav-search-icon")||s.is(o)||(o.fadeOut("fast"),t.removeClass("opened").addClass("closed"))})}(),i=".collapse-box .collapse-content",a(s=".collapse-box .collapse-title").click(function(){var e=a(this).siblings(i);0==e.is(":visible")?(e.animate({height:"show",opacity:"show"},500,function(){e.show()}),a(this).addClass("active"),a(this).closest(".field-item").siblings(".field-item").find(s).siblings(i).each(function(){var e=a(this),s=e.prev();e.animate({height:"hide",opacity:"hide"},500,function(){e.hide()}),s.removeClass("active")})):(e.animate({height:"hide",opacity:"hide"},500,function(){e.hide()}),a(this).removeClass("active"))})});;
